...
export const ALL_ACHIEVEMENTS = [
  ...
  { code: "photographer", title: "Fotógrafa de plantas", description: "50 fotos subidas.", icon: "📸" },
  { code: "punctual_7", title: "Semana puntual", description: "7 días seguidos sin retrasos en el riego.", icon: "⏰" },
  { code: "punctual_14", title: "Quincena puntual", description: "14 días seguidos sin retrasos.", icon: "📅" },
  { code: "punctual_30", title: "Mes puntual", description: "30 días seguidos sin retrasos. ¡Una máquina!", icon: "🏅" },
