  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-emerald-50 p-4">
      <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-xl">
        <h1 className="mb-4 text-center text-2xl font-bold text-emerald-900">🔑 Recuperar contraseña</h1>
        {sent ? (
          <div className="text-center">
            ...
            <Link href="/" className="text-sm text-emerald-700 hover:underline">Volver al inicio</Link>
          </div>
        ) : (
